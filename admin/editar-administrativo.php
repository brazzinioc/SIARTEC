      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Datos del administrativo</h3>
            ...
            <?php 
                $administrativo = extraeAdministrativo($id) -> fetch_assoc();
            ...
            <form role="form" name="guardar-registro" id="guardar-registro" method="POST" action="includes/modelos/modelo-administrativo.php"> 
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="8"  class="form-control" id="dni" name="dni" value="<?php echo $administrativo['dni']; ?>" required="true">
                    </div>

                    <div class="form-group">
                      <label for="nombres">Nombres:</label>
                      <input type="text" class="form-control" id="nombres" name="nombres" value="<?php echo $administrativo['nombres']; ?>" required="true">
                    </div>

                    <div class="form-group">
                      <label for="apellidos">Apellidos:</label>
                      <input type="text" class="form-control" id="apellidos" name="apellidos" value="<?php echo $administrativo['apellidos']; ?>" required="true">
                    </div>
                      ...
                      <select class="form-control select2" id="tipoUsuario" name="tipoUsuario" style="width: 100%;">
                        ...
                        <?php 
                          ...
                          foreach( $tipoUsuarios as $tipoUsuario ):
                            if($tipoUsuario['id'] === $administrativo['idTipoUsuario']){
                        ?>  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="cargo" name="cargo" value="<?php echo $administrativo['cargo']; ?>" required="true">
                    </div>

                    <div class="form-group">
                      <label for="profesion">Profesión:</label>
                      <input type="text" class="form-control" id="profesion" name="profesion" value="<?php echo $administrativo['profesion']; ?>" required="true">
                    </div>
