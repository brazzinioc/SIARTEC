    ...
    <section class="content-header">
      <h1>
       Registro de Docentes
        <small>Llene el formulario para poder registrar un docente</small>
      </h1>
    </section>
            ...
            <form role="form" name="guardar-registro" id="guardar-registro" method="POST" action="includes/modelos/modelo-docente.php"> 
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="8"  class="form-control" id="dni" name="dni" placeholder="Ingresa DNI del docente" required="true">
                    </div>

                    <div class="form-group">
                      <label for="nombres">Nombres:</label>
                      <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Ingresa nombres del docente" required="true">
                    </div>

                    <div class="form-group">
                      <label for="apellidos">Apellidos:</label>
                      <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Ingresa apellidos del docente" required="true">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="especialidad" name="especialidad" placeholder="Ingresa la especialidad del docente" required="true">
                    </div>
